...
1. Na parte inferior da janela do Copilot Chat, use o seletor para trocar para o modo **Agent**.
   ...
   <img width="350" alt="image" src="https://github.com/ian-collares-serpro/skills-getting-started-with-github-copilot-ian-collares/blob/main/.github/images/agent-mode-dropdown.png?raw=true" />
...
1. Abra os arquivos relacionados à página web e arraste cada aba (ou arquivo) para o painel de chat, informando ao Copilot que eles devem ser usados como contexto.
   ...
   <img width="400" alt="image showing files added to context" src="https://github.com/ian-collares-serpro/skills-getting-started-with-github-copilot-ian-collares/blob/main/.github/images/files-added-to-context.png?raw=true" />
...
1. Peça ao Copilot para atualizar o projeto e exibir os participantes atuais das atividades. Aguarde os edits chegarem e serem aplicados.
   ...
   Com os botões **Keep** mostrados abaixo, você pode aceitar/descartar todas as mudanças ou revisar uma a uma. Isso pode ser feito no painel de chat ou ao inspecionar cada arquivo editado.
      ...
      <img width="900" alt="buttons to keep or discard changes" src="https://github.com/ian-collares-serpro/skills-getting-started-with-github-copilot-ian-collares/blob/main/.github/images/review-changes-buttons.png?raw=true" />
...
1. Antes de simplesmente aceitar as alterações, abra o site novamente e verifique se tudo foi atualizado conforme esperado.
   ...
   <img width="350" alt="Activity card with participant info" src="https://github.com/ian-collares-serpro/skills-getting-started-with-github-copilot-ian-collares/blob/main/.github/images/activity-card-with-participants.png?raw=true" />
...
1. Verifique se o Copilot ainda está no modo **Agent**.
   ...
   <img width="250" alt="agent mode" src="https://github.com/ian-collares-serpro/skills-getting-started-with-github-copilot-ian-collares/blob/main/.github/images/agent-mode-dropdown.png?raw=true" />

1. Clique no ícone de **Tools** e explore todas as ferramentas disponíveis para o Copilot Agent Mode.

   <img width="250"  alt="tools icon" src="https://github.com/ian-collares-serpro/skills-getting-started-with-github-copilot-ian-collares/blob/main/.github/images/tools-icon.png?raw=true" />
