...
1. Abra o painel do **Copilot Chat** e troque para **Plan Agent**.
   ...
   <img width="350" alt="image" src="https://github.com/ian-collares-serpro/skills-getting-started-with-github-copilot-ian-collares/blob/main/.github/images/plan-mode-dropdown.png?raw=true" />
...
1. Revise o plano proposto e, quando estiver satisfeito, clique em **Start implementation** para transferir para o **Agent Mode**.
   ...
   <img width="350" alt="image" src="https://github.com/ian-collares-serpro/skills-getting-started-with-github-copilot-ian-collares/blob/main/.github/images/plan-mode-start-implementation.png?raw=true" />
